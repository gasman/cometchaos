...
class DirtyTest < Test::Unit::TestCase
  # read_attribute should return frozen strings.
  def test_string_attributes_should_be_frozen
    person = DirtyTestSubject.new('name' => 'hmm')
    assert person.name.frozen?
    assert_raise(TypeError) { person.name << 'ouch' }
  end
